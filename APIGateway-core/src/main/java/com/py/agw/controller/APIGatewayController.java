...
import static com.py.agw.model.ErrorCode.PARAM_ERROR;
...
public class APIGatewayController {
    ...
    public Result<String> v1Service(
        ...
        try {
            ...
            LOGGER.info("request sys: {}, api: {}, out: {}, nonce: {}, sig: {}, param: {}",
                    sys, apiName, outName, nonce, signature, param);
            ...
            LOGGER.warn("system error, sys: {}, api: {}, cause: ", sys, apiName, ex);
